...
public class onboarding1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root=inflater.inflate(R.layout.fragment_oboarding1, container, false);
        AppCompatButton nextbot;
        nextbot=root.findViewById(R.id.nextbot);
        nextbot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                getActivity().getSupportFragmentManager().beginTransaction().add(R.id.startupViewContainer,new onboarding2()).commit();
            }
        });
        return root;
    }
