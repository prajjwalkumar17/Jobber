...
public class AdapterAllApliedJobs  extends RecyclerView.Adapter<AdapterAllApliedJobs.recycler> {
    JSONObject object;
    Activity myactivity;
    Context thisContext;
    ...
    public AdapterAllApliedJobs(JSONObject object, Activity myactivity, Context thisContext, RecyclerHomePopularOnClick recyclerHomePopularOnClick) {
        this.object = object;
