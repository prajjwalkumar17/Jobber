...
public class AdapterAppliedJobs extends RecyclerView.Adapter<AdapterAppliedJobs.recycler> {
    JSONObject object;
    Activity myactivity;
    Context thisContext;
    ...
    public AdapterAppliedJobs(JSONObject object, Activity myactivity, Context thisContext, RecyclerHomeFeaturedCompleteClick recyclerHomeFeaturedCompleteClick) {
        this.object = object;
    ...
    @NonNull
    @Override
    public AdapterAppliedJobs.recycler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
  ...
  /*          String id = realres.optString("_id");
    ...
    public int getItemCount() {
        length = object.optJSONObject("data").optJSONArray("jobsApplied").length();
